...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen w-full bg-[#F0F4F8] flex items-center justify-center p-4 md:p-8 font-sans text-black overflow-hidden relative">
      ...
      <motion.div
        ...
        className="w-full max-w-[1100px] h-[750px] bg-white rounded-[40px] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-white/40 overflow-hidden relative z-10 flex"
      >
        <div className={`flex w-full transition-all duration-700`}>
          {/* Blue Panel - Branding */}
          <motion.div 
            layout
            className={`hidden md:flex w-[40%] bg-primary-blue p-16 text-white flex-col justify-between relative overflow-hidden`}
          >
            <div className="relative z-10">
              ...
              <div className="space-y-8 max-w-[320px]">
                <div>
                   <h2 className="text-2xl font-black text-white uppercase tracking-widest leading-none mb-6">Welcome Back to the Node</h2>
