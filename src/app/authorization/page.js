...
export default function AuthorizationGateway() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#f4f6f8] flex items-center justify-center p-4 font-sans text-black relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-blue/5 rounded-full blur-[100px]" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent-indigo/5 rounded-full blur-[100px]" />
      ...
      >
        <div className="w-16 h-16 bg-primary-blue rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-primary-blue/20">
        ...
        <form onSubmit={handleAuthorize} className="w-full space-y-5">
          <div>
            <input
              ...
              className="w-full bg-[#F8FAFC] border border-[#E2E8F0] focus:border-primary-blue focus:bg-white transition-all rounded-[20px] py-6 text-center text-lg font-bold tracking-[0.5em] outline-none text-[#64748B] placeholder:text-[#94A3B8]"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-blue text-white py-6 rounded-[20px] font-black text-[17px] tracking-[0.2em] uppercase hover:bg-deep-indigo transition-all shadow-lg active:scale-[0.98] flex items-center justify-center gap-3 h-[64px]"
          >
            {loading ? (
